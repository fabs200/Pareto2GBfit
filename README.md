...
|          `ci`          |                                                                                  `True`                                                                                 | display 95% CIs of bootstrapped parameters                                                                                                                                                                                                                                                                                                           |
...
| `rejection_criterion`  | `[LRtest, 'AIC']`                                                                                                                                                       | model selection procedures based on LR test and on AIC, both test nested parameter restrictions in the log-likelihood (restricted model) and compare it with the unrestricted log-likelihood (full model). You can also specify `AIC_alternative` which only compares the AICs of the fitted models without nested parameter restrictions.                                                                    |
