...
|           `b`          |                                                                                    --                                                                                   | lower bound                                                                                                                                                                                                                                                                                                                                                         |
|        `weights`       |                                                                              `array([1., 1., 1., ...])`                                                                 | array with frequency weights, default is a `numpy.ones` array of same shape as `x`. Note that that each observation in x is "inflated" w-times. Thus, `weights` needs to be an integer array ideally `numpy.int64` to prevent loss of precision.                                                                                                                    |
