...
Bootstrapping 100%|##############################################|Time: 0:00:03
Bootstrapping 100%|##############################################|Time: 0:01:02
```
...
```
LRtest(Pareto(x=netwealth, b=b, p=p_fit1).LL, GB1(x=netwealth, b=b, a=a_fit3, p=p_fit3, q=q_fit3).LL, df=2)
```
Output:
```
+-------------+----------+
...
Finally, the LR test indicates that the IB1 fits the data best.
...
|  IB1   | 185686.957 | 185700.682 | 549969.043 | 22887341069249.562 |  4784071.6  | 4.091 | -92841.478 | -140210160.517 | 496338.458 |  753115151267.842  | 516189.818 | 24693433986030.39 | 1  | 7063 | 7063 |
|  GB1   | 185971.15  | 185991.738 | 472794.361 | 23400446738451.49  | 4837400.825 | 4.579 | -92982.575 | -912433299.364 | 387004.869 |  469527614265.387  | 516189.818 | 24693433986030.39 | 1  | 7063 | 7063 |
