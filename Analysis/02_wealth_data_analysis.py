...
for b in [100000, 500000, 1000000, 1500000, 2500000, 5000000]:
    ...
    for year in ['01', '03', '05', '07', '09', '11', '13', '15', '17']:
        ...
        # AIC2
        globals()['fit_result_psid_{}_{}'.format(year, 'AIC_alternative')] = result[2]
        globals()['fit_psid_{}_{}'.format(year, 'AIC_alternative')] = prep_fit_results_for_table(result[2])
    ...
    for year in ['02', '07', '12']:
        ...
        globals()['fit_result_soep_{}_{}'.format(year, 'AIC_alternative')] = result[2]
        globals()['fit_soep_{}_{}'.format(year, 'AIC_alternative')] = prep_fit_results_for_table(result[2])
    ...
    df_wealth_results_LR = pd.DataFrame(np.array([['best fitted model', '{}'.format(fit_result_psid_01_LRtest[0]), '{}'.format(fit_result_psid_03_LRtest[0]), '{}'.format(fit_result_psid_05_LRtest[0]), '{}'.format(fit_result_psid_07_LRtest[0]), '{}'.format(fit_result_psid_09_LRtest[0]), '{}'.format(fit_result_psid_11_LRtest[0]), '{}'.format(fit_result_psid_13_LRtest[0]), '{}'.format(fit_result_psid_15_LRtest[0]), '{}'.format(fit_result_psid_17_LRtest[0]), '{}'.format(fit_result_soep_02_LRtest[0]), '{}'.format(fit_result_soep_07_LRtest[0]), '{}'.format(fit_result_soep_12_LRtest[0])],
                                               ...
                                               [' ',               '[{};{}]'.format(fit_psid_01_LRtest[]; fit_psid_01_LRtest),  '[{};{}]'.format(a_cilo2, a_cihi2),  '{}'.format(a_cilo3, a_cihi3),  '{}'.format(a_cilo, a_cihi4),  '{}'.format(fit_psid_09_LRtest[0]),  '{}'.format(fit_psid_11_LRtest[0]),  '{}'.format(fit_psid_13_LRtest[0]),  '{}'.format(fit_psid_15_LRtest[0]),  '{}'.format(fit_psid_17_LRtest[0]),  '{}'.format(fit_soep_02_LRtest[0]),  '{}'.format(fit_soep_07_LRtest[0]),  '{}'.format(fit_soep_12_LRtest[0])],
                                               ...
                                               ['c',               '{}'.format(fit_psid_01_LRtest[2]),  '{}'.format(fit_psid_03_LRtest[2]),  '{}'.format(fit_psid_05_LRtest[2]),  '{}'.format(fit_psid_07_LRtest[2]),  '{}'.format(fit_psid_09_LRtest[2]),  '{}'.format(fit_psid_11_LRtest[2]),  '{}'.format(fit_psid_13_LRtest[2]),  '{}'.format(fit_psid_15_LRtest[2]),  '{}'.format(fit_psid_17_LRtest[2]),  '{}'.format(fit_soep_02_LRtest[2]),  '{}'.format(fit_soep_07_LRtest[2]),  '{}'.format(fit_soep_12_LRtest[2])],
                                               ['c',               '{}'.format(fit_psid_01_LRtest[2]),  '{}'.format(fit_psid_03_LRtest[2]),  '{}'.format(fit_psid_05_LRtest[2]),  '{}'.format(fit_psid_07_LRtest[2]),  '{}'.format(fit_psid_09_LRtest[2]),  '{}'.format(fit_psid_11_LRtest[2]),  '{}'.format(fit_psid_13_LRtest[2]),  '{}'.format(fit_psid_15_LRtest[2]),  '{}'.format(fit_psid_17_LRtest[2]),  '{}'.format(fit_soep_02_LRtest[2]),  '{}'.format(fit_soep_07_LRtest[2]),  '{}'.format(fit_soep_12_LRtest[2])],
                                               [' ',               '({})'.format(fit_psid_01_LRtest[3]),  '({})'.format(fit_psid_03_LRtest[3]),  '({})'.format(fit_psid_05_LRtest[3]),  '({})'.format(fit_psid_07_LRtest[3]),  '({})'.format(fit_psid_09_LRtest[3]),  '({})'.format(fit_psid_11_LRtest[3]),  '({})'.format(fit_psid_13_LRtest[3]),  '({})'.format(fit_psid_15_LRtest[3]),  '({})'.format(fit_psid_17_LRtest[3]),  '({})'.format(fit_soep_02_LRtest[3]),  '({})'.format(fit_soep_07_LRtest[3]),  '({})'.format(fit_soep_12_LRtest[3])],
                                               ...
                                               ['q',               '{}'.format(fit_psid_01_LRtest[6]),  '{}'.format(fit_psid_03_LRtest[6]),  '{}'.format(fit_psid_05_LRtest[6]),  '{}'.format(fit_psid_07_LRtest[6]),  '{}'.format(fit_psid_09_LRtest[6]),  '{}'.format(fit_psid_11_LRtest[6]),  '{}'.format(fit_psid_13_LRtest[6]),  '{}'.format(fit_psid_15_LRtest[6]),  '{}'.format(fit_psid_17_LRtest[6]),  '{}'.format(fit_soep_02_LRtest[6]),  '{}'.format(fit_soep_07_LRtest[6]),  '{}'.format(fit_soep_12_LRtest[6])],
                                               ['q',               '{}'.format(fit_psid_01_LRtest[6]),  '{}'.format(fit_psid_03_LRtest[6]),  '{}'.format(fit_psid_05_LRtest[6]),  '{}'.format(fit_psid_07_LRtest[6]),  '{}'.format(fit_psid_09_LRtest[6]),  '{}'.format(fit_psid_11_LRtest[6]),  '{}'.format(fit_psid_13_LRtest[6]),  '{}'.format(fit_psid_15_LRtest[6]),  '{}'.format(fit_psid_17_LRtest[6]),  '{}'.format(fit_soep_02_LRtest[6]),  '{}'.format(fit_soep_07_LRtest[6]),  '{}'.format(fit_soep_12_LRtest[6])],
                                               [' ',               '({})'.format(fit_psid_01_LRtest[7]),  '({})'.format(fit_psid_03_LRtest[7]),  '({})'.format(fit_psid_05_LRtest[7]),  '({})'.format(fit_psid_07_LRtest[7]),  '({})'.format(fit_psid_09_LRtest[7]),  '({})'.format(fit_psid_11_LRtest[7]),  '({})'.format(fit_psid_13_LRtest[7]),  '({})'.format(fit_psid_15_LRtest[7]),  '({})'.format(fit_psid_17_LRtest[7]),  '({})'.format(fit_soep_02_LRtest[7]),  '({})'.format(fit_soep_07_LRtest[7]),  '({})'.format(fit_soep_12_LRtest[7])],
                                               ...
                                               ['LL',              '{}'.format(fit_psid_01_LRtest[11]) , '{}'.format(fit_psid_03_LRtest[11]) , '{}'.format(fit_psid_05_LRtest[11]) , '{}'.format(fit_psid_07_LRtest[11]) , '{}'.format(fit_psid_09_LRtest[11]) , '{}'.format(fit_psid_11_LRtest[11]) , '{}'.format(fit_psid_13_LRtest[11]) , '{}'.format(fit_psid_15_LRtest[11]) , '{}'.format(fit_psid_17_LRtest[11]) , '{}'.format(fit_soep_02_LRtest[11]) , '{}'.format(fit_soep_07_LRtest[11]) , '{}'.format(fit_soep_12_LRtest[11])],
                                               ['AIC',             '{}'.format(fit_psid_01_LRtest[8]) , '{}'.format(fit_psid_03_LRtest[8]) , '{}'.format(fit_psid_05_LRtest[8]) , '{}'.format(fit_psid_07_LRtest[8]) , '{}'.format(fit_psid_09_LRtest[8]) , '{}'.format(fit_psid_11_LRtest[8]) , '{}'.format(fit_psid_13_LRtest[8]) , '{}'.format(fit_psid_15_LRtest[8]) , '{}'.format(fit_psid_17_LRtest[8]) , '{}'.format(fit_soep_02_LRtest[8]) , '{}'.format(fit_soep_07_LRtest[8]) , '{}'.format(fit_soep_12_LRtest[8])],
                                               ['MSE',             '{}'.format(fit_psid_01_LRtest[9]), '{}'.format(fit_psid_03_LRtest[9]), '{}'.format(fit_psid_05_LRtest[9]), '{}'.format(fit_psid_07_LRtest[9]), '{}'.format(fit_psid_09_LRtest[9]), '{}'.format(fit_psid_11_LRtest[9]), '{}'.format(fit_psid_13_LRtest[9]), '{}'.format(fit_psid_15_LRtest[9]), '{}'.format(fit_psid_17_LRtest[9]), '{}'.format(fit_soep_02_LRtest[9]), '{}'.format(fit_soep_07_LRtest[9]), '{}'.format(fit_soep_12_LRtest[9])],
                                               ['RMSE',            '{}'.format(fit_psid_01_LRtest[10]), '{}'.format(fit_psid_03_LRtest[10]), '{}'.format(fit_psid_05_LRtest[10]), '{}'.format(fit_psid_07_LRtest[10]), '{}'.format(fit_psid_09_LRtest[10]), '{}'.format(fit_psid_11_LRtest[10]), '{}'.format(fit_psid_13_LRtest[10]), '{}'.format(fit_psid_15_LRtest[10]), '{}'.format(fit_psid_17_LRtest[10]), '{}'.format(fit_soep_02_LRtest[10]), '{}'.format(fit_soep_07_LRtest[10]), '{}'.format(fit_soep_12_LRtest[10])],
                                               ['emp. mean',       '{}'.format(fit_psid_01_LRtest[12]), '{}'.format(fit_psid_03_LRtest[12]), '{}'.format(fit_psid_05_LRtest[12]), '{}'.format(fit_psid_07_LRtest[12]), '{}'.format(fit_psid_09_LRtest[12]), '{}'.format(fit_psid_11_LRtest[12]), '{}'.format(fit_psid_13_LRtest[12]), '{}'.format(fit_psid_15_LRtest[12]), '{}'.format(fit_psid_17_LRtest[12]), '{}'.format(fit_soep_02_LRtest[12]), '{}'.format(fit_soep_07_LRtest[12]), '{}'.format(fit_soep_12_LRtest[12])],
                                               ...
                                               ['pred. mean',      '{}'.format(fit_psid_01_LRtest[14]), '{}'.format(fit_psid_03_LRtest[14]), '{}'.format(fit_psid_05_LRtest[14]), '{}'.format(fit_psid_07_LRtest[14]), '{}'.format(fit_psid_09_LRtest[14]), '{}'.format(fit_psid_11_LRtest[14]), '{}'.format(fit_psid_13_LRtest[14]), '{}'.format(fit_psid_15_LRtest[14]), '{}'.format(fit_psid_17_LRtest[14]), '{}'.format(fit_soep_02_LRtest[14]), '{}'.format(fit_soep_07_LRtest[14]), '{}'.format(fit_soep_12_LRtest[14])],
                                               ['pred. var.',      '{}'.format(fit_psid_01_LRtest[15]), '{}'.format(fit_psid_03_LRtest[15]), '{}'.format(fit_psid_05_LRtest[15]), '{}'.format(fit_psid_07_LRtest[15]), '{}'.format(fit_psid_09_LRtest[15]), '{}'.format(fit_psid_11_LRtest[15]), '{}'.format(fit_psid_13_LRtest[15]), '{}'.format(fit_psid_15_LRtest[15]), '{}'.format(fit_psid_17_LRtest[15]), '{}'.format(fit_soep_02_LRtest[15]), '{}'.format(fit_soep_07_LRtest[15]), '{}'.format(fit_soep_12_LRtest[15])],
                                               ...
                                               ['N',               '{}'.format(fit_psid_01_LRtest[17]), '{}'.format(fit_psid_03_LRtest[17]), '{}'.format(fit_psid_05_LRtest[17]), '{}'.format(fit_psid_07_LRtest[17]), '{}'.format(fit_psid_09_LRtest[17]), '{}'.format(fit_psid_11_LRtest[17]), '{}'.format(fit_psid_13_LRtest[17]), '{}'.format(fit_psid_15_LRtest[17]), '{}'.format(fit_psid_17_LRtest[17]), '{}'.format(fit_soep_02_LRtest[17]), '{}'.format(fit_soep_07_LRtest[17]), '{}'.format(fit_soep_12_LRtest[17])]
                                               ]),
                                     columns=['', '01', '03', '05', '07', '09', '11', '13', '15', '17', 'SOEP02', 'SOEP07', 'SOEP12', 'SOEP17'])

    df_wealth_results_AIC = pd.DataFrame(np.array([['best fitted model', '{}'.format(fit_result_psid_01_AIC[0]), '{}'.format(fit_result_psid_03_AIC[0]), '{}'.format(fit_result_psid_05_AIC[0]), '{}'.format(fit_result_psid_07_AIC[0]), '{}'.format(fit_result_psid_09_AIC[0]), '{}'.format(fit_result_psid_11_AIC[0]), '{}'.format(fit_result_psid_13_AIC[0]), '{}'.format(fit_result_psid_15_AIC[0]), '{}'.format(fit_result_psid_17_AIC[0]), '{}'.format(fit_result_soep_02_AIC[0]), '{}'.format(fit_result_soep_07_AIC[0]), '{}'.format(fit_result_soep_12_AIC[0])],
                                               ...
                                               ['c',               '{}'.format(fit_psid_01_AIC[2]),  '{}'.format(fit_psid_03_AIC[2]),  '{}'.format(fit_psid_05_AIC[2]),  '{}'.format(fit_psid_07_AIC[2]),  '{}'.format(fit_psid_09_AIC[2]),  '{}'.format(fit_psid_11_AIC[2]),  '{}'.format(fit_psid_13_AIC[2]),  '{}'.format(fit_psid_15_AIC[2]),  '{}'.format(fit_psid_17_AIC[2]),  '{}'.format(fit_soep_02_AIC[2]),  '{}'.format(fit_soep_07_AIC[2]),  '{}'.format(fit_soep_12_AIC[2])],
                                               [' ',               '({})'.format(fit_psid_01_AIC[3]),  '({})'.format(fit_psid_03_AIC[3]),  '({})'.format(fit_psid_05_AIC[3]),  '({})'.format(fit_psid_07_AIC[3]),  '({})'.format(fit_psid_09_AIC[3]),  '({})'.format(fit_psid_11_AIC[3]),  '({})'.format(fit_psid_13_AIC[3]),  '({})'.format(fit_psid_15_AIC[3]),  '({})'.format(fit_psid_17_AIC[3]),  '({})'.format(fit_soep_02_AIC[3]),  '({})'.format(fit_soep_07_AIC[3]),  '({})'.format(fit_soep_12_AIC[3])],
                                               ...
                                               ['q',               '{}'.format(fit_psid_01_AIC[6]),  '{}'.format(fit_psid_03_AIC[6]),  '{}'.format(fit_psid_05_AIC[6]),  '{}'.format(fit_psid_07_AIC[6]),  '{}'.format(fit_psid_09_AIC[6]),  '{}'.format(fit_psid_11_AIC[6]),  '{}'.format(fit_psid_13_AIC[6]),  '{}'.format(fit_psid_15_AIC[6]),  '{}'.format(fit_psid_17_AIC[6]),  '{}'.format(fit_soep_02_AIC[6]),  '{}'.format(fit_soep_07_AIC[6]),  '{}'.format(fit_soep_12_AIC[6])],
                                               [' ',               '({})'.format(fit_psid_01_AIC[7]),  '({})'.format(fit_psid_03_AIC[7]),  '({})'.format(fit_psid_05_AIC[7]),  '({})'.format(fit_psid_07_AIC[7]),  '({})'.format(fit_psid_09_AIC[7]),  '({})'.format(fit_psid_11_AIC[7]),  '({})'.format(fit_psid_13_AIC[7]),  '({})'.format(fit_psid_15_AIC[7]),  '({})'.format(fit_psid_17_AIC[7]),  '({})'.format(fit_soep_02_AIC[7]),  '({})'.format(fit_soep_07_AIC[7]),  '({})'.format(fit_soep_12_AIC[7])],
                                               ['lower bound b',   '{}'.format(b),                      '{}'.format(b),                     '{}'.format(b),                       '{}'.format(b),                      '{}'.format(b),                      '{}'.format(b),                      '{}'.format(b),                      '{}'.format(b),                      '{}'.format(b),                      '{}'.format(b),                      '{}'.format(b),                      '{}'.format(b)],
                                               ...
                                               ['MSE',             '{}'.format(fit_psid_01_AIC[9]), '{}'.format(fit_psid_03_AIC[9]), '{}'.format(fit_psid_05_AIC[9]), '{}'.format(fit_psid_07_AIC[9]), '{}'.format(fit_psid_09_AIC[9]), '{}'.format(fit_psid_11_AIC[9]), '{}'.format(fit_psid_13_AIC[9]), '{}'.format(fit_psid_15_AIC[9]), '{}'.format(fit_psid_17_AIC[9]), '{}'.format(fit_soep_02_AIC[9]), '{}'.format(fit_soep_07_AIC[9]), '{}'.format(fit_soep_12_AIC[9])],
                                               ['RMSE',            '{}'.format(fit_psid_01_AIC[10]), '{}'.format(fit_psid_03_AIC[10]), '{}'.format(fit_psid_05_AIC[10]), '{}'.format(fit_psid_07_AIC[10]), '{}'.format(fit_psid_09_AIC[10]), '{}'.format(fit_psid_11_AIC[10]), '{}'.format(fit_psid_13_AIC[10]), '{}'.format(fit_psid_15_AIC[10]), '{}'.format(fit_psid_17_AIC[10]), '{}'.format(fit_soep_02_AIC[10]), '{}'.format(fit_soep_07_AIC[10]), '{}'.format(fit_soep_12_AIC[10])],
                                               ...
                                               ['pred. mean',      '{}'.format(fit_psid_01_AIC[14]), '{}'.format(fit_psid_03_AIC[14]), '{}'.format(fit_psid_05_AIC[14]), '{}'.format(fit_psid_07_AIC[14]), '{}'.format(fit_psid_09_AIC[14]), '{}'.format(fit_psid_11_AIC[14]), '{}'.format(fit_psid_13_AIC[14]), '{}'.format(fit_psid_15_AIC[14]), '{}'.format(fit_psid_17_AIC[14]), '{}'.format(fit_soep_02_AIC[14]), '{}'.format(fit_soep_07_AIC[14]), '{}'.format(fit_soep_12_AIC[14])],
                                               ['pred. var.',      '{}'.format(fit_psid_01_AIC[15]), '{}'.format(fit_psid_03_AIC[15]), '{}'.format(fit_psid_05_AIC[15]), '{}'.format(fit_psid_07_AIC[15]), '{}'.format(fit_psid_09_AIC[15]), '{}'.format(fit_psid_11_AIC[15]), '{}'.format(fit_psid_13_AIC[15]), '{}'.format(fit_psid_15_AIC[15]), '{}'.format(fit_psid_17_AIC[15]), '{}'.format(fit_soep_02_AIC[15]), '{}'.format(fit_soep_07_AIC[15]), '{}'.format(fit_soep_12_AIC[15])],
    ...
    df_wealth_results_AIC2 = pd.DataFrame(np.array([['best fitted model', '{}'.format(fit_result_psid_01_AIC2[0]), '{}'.format(fit_result_psid_03_AIC2[0]), '{}'.format(fit_result_psid_05_AIC2[0]), '{}'.format(fit_result_psid_07_AIC2[0]), '{}'.format(fit_result_psid_09_AIC2[0]), '{}'.format(fit_result_psid_11_AIC2[0]), '{}'.format(fit_result_psid_13_AIC2[0]), '{}'.format(fit_result_psid_15_AIC2[0]), '{}'.format(fit_result_psid_17_AIC2[0]), '{}'.format(fit_result_soep_02_AIC2[0]), '{}'.format(fit_result_soep_07_AIC2[0]), '{}'.format(fit_result_soep_12_AIC2[0])],
